...
export function Hero() {
    ...
    return (
        <section className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-black pb-24 pt-32">
            ...
            <div className="relative z-10 w-full px-6 flex flex-col items-center">
                <div className="flex flex-col items-center space-y-0 text-center">
                    ...
                    <h1 className="font-heading font-black text-[6vw] leading-[0.85] uppercase tracking-[-0.04em] text-white flex flex-col">
                        <span className="relative inline-block animate-in fade-in slide-in-from-left-20 duration-1000">
                            Progress by
                        </span>
                        <span className="relative inline-block -mt-[0.5vw] animate-in fade-in slide-in-from-right-20 duration-1000 delay-200">
                            Design.
                        </span>
                    </h1>
                </div>
